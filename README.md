...
# Знакомство с Функциями Высшего Порядка(ФВП)
Первые три задания - тренировочные, нужны для отработки ваших навыков. Оцениваются только задания №4 и №5. 

формат сдачи - ссылка на гитхаб репозиторий
